...
import useField, {
    ...
    useFieldEmits,
    fieldValueIsFilled,
} from 'quasar/src/composables/private/use-field.js'
import { useVirtualScroll, useVirtualScrollProps } from 'quasar/src/components/virtual-scroll/use-virtual-scroll.js'
...
import { isDeepEqual } from 'quasar/src/utils/private/is.js'
...
import { shouldIgnoreKey, isKeyCode } from 'quasar/src/utils/private/key-composition.js'
import { hMergeSlot } from 'quasar/src/utils/private/render.js'
...
export default createComponent({
    ...
    setup(props, { slots, emit }) {
        ...
        const needsHtmlFn = computed(() =>
            props.optionsHtml === true ? () => true : opt => opt !== void 0 && opt !== null && opt.html === true,
        )
        ...
        function onTargetKeydown(e) {
            ...
            const newValueModeValid =
                inputValue.value.length > 0 && (props.newValueMode !== void 0 || props.onNewValue !== void 0)

            const tabShouldSelect =
                e.shiftKey !== true && props.multiple !== true && (optionIndex.value > -1 || newValueModeValid === true)
