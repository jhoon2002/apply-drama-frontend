<style>
@import '../../css/vue-select/vue-select.css';
</style>
        ...
        >
            ...
            <div ref="selectedOptions" class="vs__selected-options">
                ...
                <slot name="search" v-bind="scope.search">
                    <!--<q-input class="vs__search" v-bind="scope.search.attributes" />-->
...
import childComponents from './(del)childComponents'
 ...
 */
export default {
    components: { ...childComponents, JInput },
